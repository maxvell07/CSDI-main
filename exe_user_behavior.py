...
parser.add_argument(
    "--nfold", type=int, default=0, help="for cross-validation (valid value:[0-4])"
)
...
foldername = "./save/user_behavior_fold" + str(args.nfold) + "_" + current_time + "/"
...
model = CSDI_UserBehavior(config, args.device).to(args.device)
